...
# ALIGN_POINTS = ( RIGHT_EYE_POINTS + LEFT_EYE_POINTS )
...
# im = cv2.imread("IMG_2387.JPG", cv2.IMREAD_COLOR)
# im2 = cv2.resize(im, (720, 500))
...
while(cap.isOpened()):
    ...
    if landmarks1 != None :    
        ...
        #                       axis=0)
        # # cv2.imshow('frame4',combined_mask)
        # # cv2.imshow('frame5',warped_mask)
